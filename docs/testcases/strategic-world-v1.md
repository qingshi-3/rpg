...
- 编成面板显示英雄位；V1 当前显示暂无可选英雄。
- 编成面板显示民兵数量，并且不能超过来源场域可用驻军。
- 右键空地后创建玩家小队，来源为玩家营地，意图为 `MoveToPosition`。
- 玩家营地民兵数量减少，小队在大地图上可见并被选中。
...
- 从玩家营地点击出征，选择民兵后右键点击埋骨地。
- 再次从玩家营地点击出征，选择民兵后右键点击墓园。
