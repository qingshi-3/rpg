...
Design documents should separate overview, detailed specification, and implementation notes. If a section becomes too dense, move it to a focused child document and leave a link behind.
