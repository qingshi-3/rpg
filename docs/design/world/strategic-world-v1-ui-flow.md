...
- 己方场域行动面板提供“出征”入口；玩家从来源场域选择兵团，再回到大地图右键选择目的地。
...
攻打埋骨地应从己方场域“出征”发起：选择玩家营地或其他己方场域，点击出征，选择英雄和兵团，再在大地图右键埋骨地。
...
- 选中己方场域。
- 点击 `出征`。
- 在右侧编成中选择英雄和兵团；V1 当前只有民兵，英雄位显示暂无。
- 点击 `选择目的地`。
- 在大地图右键敌方场域、己方场域或空地。
- 创建小队时从出发场域扣除所选兵团；进驻或攻占胜利后再写回目标场域驻军。
