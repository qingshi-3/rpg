...
Detailed summoned-character relationship layering lives in `../../20-game-design/officer-social/summoned-social-relationship-model.md`.
Talent, rank, direct-control slots, and promotion boundaries live in `../../20-game-design/officer-social/unit-talent-rank-control.md`.
