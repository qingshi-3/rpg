...
本文根据当前产品方向“大地图战略 + 人物社交经营 + 回合制战棋的战略 RPG”拆分项目系统。三群式势力生态是战略地图骨架之一。
...
一局游戏不是单场战斗，而是一段由战略地图、人物经营和战棋冲突共同推进的战役。顶层 Flow 负责在大地图、野外机会、场域、人物事件、战斗和结算之间切换。
...
- `docs/30-technical-design/battle/unit-system.md`
...
详细规则见 `../relationship/emotion-system.md`。
...
- `docs/30-technical-design/content-pipeline/content-authoring-architecture.md`
...
当前实现优先级见 `../../50-production/roadmap/development-priority.md`。系统层面的 V1 顺序是：
