# World Technical Index

This directory stores implementation-facing world-layer contracts, data models, navigation, battle handoff, and deployment rules.
...
Player-facing strategic-map design lives in `../../20-game-design/strategic-map/`.
