...
- Target pointers and target-cell fills are separate presentation concepts. Hover previews may show red target pointers over valid units without painting a target cell under those units; range cells should remain only on empty range positions.
