...
- Exported paths and scene nodes have fallback or clear warnings.
...
Use `docs/testcases/smoke-check-template.md` for the shape of a smoke pass.
...
- What remains fallback or placeholder behavior.
