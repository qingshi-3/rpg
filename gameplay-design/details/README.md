# Gameplay Detail Design

This directory stores accepted detail designs for specific gameplay subsystems.

Use `../content-systems-long-term-design.md` as the global authority. Detail documents refine local rules without copying the full global design.
