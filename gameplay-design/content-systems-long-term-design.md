...
| Food | Corps creation and replenishment, garrison upkeep when added later, and long defense when added later. |
...
world-map time -> 2 reserve soldiers recovered per elapsed pulse up to remaining capacity
