...
Run("battle group session probe runs without consuming legacy handoff", BattleGroupSessionProbeRunsWithoutConsumingLegacyHandoff);
Run("battle launcher runs battle group session probe beside legacy handoff", BattleLauncherRunsBattleGroupSessionProbeBesideLegacyHandoff);
Run("battle launcher keeps legacy handoff when probe rejects snapshot", BattleLauncherKeepsLegacyHandoffWhenProbeRejectsSnapshot);
...
static void BattleGroupSessionProbeRunsWithoutConsumingLegacyHandoff()
{
    BattleSessionHandoff.CancelBattle();
...
static void BattleLauncherRunsBattleGroupSessionProbeBesideLegacyHandoff()
{
    BattleSessionHandoff.CancelBattle();
...
static void BattleLauncherKeepsLegacyHandoffWhenProbeRejectsSnapshot()
{
    BattleSessionHandoff.CancelBattle();
...
static BattleStartRequest BuildProbeBattleRequest(string requestId, string battleId, string siteId)
{
    BattleStartRequest request = new()
    {
        RequestId = requestId,
