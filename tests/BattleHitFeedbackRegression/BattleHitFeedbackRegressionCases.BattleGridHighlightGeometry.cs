...
internal static void BattleGridHighlightOverlayDelegatesGeometry()
{
    ...
    AssertTrue(
        ...
        overlay.Contains("_highlightGeometry.BuildCellPolygon", StringComparison.Ordinal) &&
        overlay.Contains("_highlightGeometry.BuildBoundarySegments", StringComparison.Ordinal) &&
