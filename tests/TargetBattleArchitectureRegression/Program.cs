...
Run("runtime movement phase allows next-tick movement continuation", TargetBattleAttackCadenceRegressionCases.RuntimeMovementPhaseAllowsNextTickMovementContinuation); Run("runtime fixed-clock waits one tick after movement boundary", TargetBattleAttackCadenceRegressionCases.RuntimeFixedClockWaitsOneTickAfterMovementBoundary); Run("runtime fixed-clock defers attack after movement boundary", TargetBattleAttackCadenceRegressionCases.RuntimeFixedClockDefersAttackAfterMovementBoundary);
