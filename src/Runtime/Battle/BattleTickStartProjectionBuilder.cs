...
internal static class BattleTickStartProjectionBuilder
{
    ...
    internal static BattleRuntimeActor Build(BattleRuntimeTickStartActorFact fact)
    {
        return new BattleRuntimeActor
        {
            ...
            MovementSteeringMode = fact.Actor.MovementSteeringMode,
            MovementSteeringSide = fact.Actor.MovementSteeringSide,
            MovementSteeringBestDistance = fact.Actor.MovementSteeringBestDistance,
            MovementSteeringBudgetRemaining = fact.Actor.MovementSteeringBudgetRemaining,
            MovementSteeringIntentKey = fact.Actor.MovementSteeringIntentKey,
