...
public static class StrategicManagementIds
{
    public const string FactionPlayer = "faction_player";
    ...
    public const string EquipmentSunLionArmor = "equipment_sun_lion_armor";
    public const string EquipmentBonefieldCommandHorn = "equipment_bonefield_command_horn";
