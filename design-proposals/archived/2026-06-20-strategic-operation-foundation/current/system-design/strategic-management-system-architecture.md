...
- location-owned persistent map facts keyed by stable layout or marker ids when those facts matter to campaign state, such as built slots, depleted resources, destroyed bridges, or resolved site events;
