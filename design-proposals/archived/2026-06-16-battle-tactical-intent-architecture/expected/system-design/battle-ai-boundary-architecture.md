...
- enemy group intent execution inside the active AI intent plan and resolved target object;
...
- enemy-controlled groups consume AI intent plans that select target objects, retarget policies, leashes, fallback intent, and engagement gates;
