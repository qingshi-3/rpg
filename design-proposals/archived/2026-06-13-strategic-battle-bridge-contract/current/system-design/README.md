...
- `battle-group-tactical-region-architecture.md`: battle-group-owned target regions, temporary regions, local combat regions, enemy region policy, and player-command separation.
