...
User accepted the expected architecture and phased implementation on 2026-05-17. Batches 1-4 are implemented and merged into `system-design/`. Batch 4.5 isolates strategic-world and world-site game rendering in real `MainWorldViewport` subviewports. Right-side notification/minimap and future battle command hosts remain future work.
