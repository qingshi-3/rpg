...
The first playable slice has no mandatory strategic battle-preparation choice before this draft. Scouting, siege-method selection, support reservation, or other strategic entry modes require a separate accepted design before becoming battle-entry requirements.
