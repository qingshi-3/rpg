...
- The static navigation graph owns terrain legality and authored movement cost. Dynamic living-unit occupancy is layered: immediate next-cell occupancy and same-tick reservations are hard blockers, while future projected occupancy is soft route cost.
