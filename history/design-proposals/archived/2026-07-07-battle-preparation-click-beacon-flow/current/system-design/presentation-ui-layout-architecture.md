...
5. Reserve `OverlayHost` for deployment highlights, drag formation previews, invalid-placement feedback, optional route previews, and optional objective/tactical marker outlines.
...
- select one or more player battle groups during live battle or tactical pause;
...
- display accepted destination beacons as world-space overlays tied to Runtime command facts;
