...
The first-version recruitment workbench is also the hero main-corps reassignment surface. Troop options should show reserve-soldier and resource consumption directly, and replacement choices should show consume, refund, and net cost before the player commits.
