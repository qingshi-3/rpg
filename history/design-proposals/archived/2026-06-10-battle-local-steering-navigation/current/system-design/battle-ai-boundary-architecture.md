...
- Movement blocked: try bounded local neighbor avoidance through Runtime movement resolution; otherwise stop advance, queue, support, hold pressure, or emit a failure candidate.
