...
| Battle target objects, AI intent plans, target selectors, tactical capability boundaries, and enemy-first intent migration | `battle-tactical-intent-architecture.md` |
...
-> Battle preparation records BattleGroupPlan values for participating battle groups
