...
- `battle-tactical-intent-architecture.md`: battle target objects, AI intent plans, target selectors, tactical capability boundaries, and enemy-first intent migration scope.
