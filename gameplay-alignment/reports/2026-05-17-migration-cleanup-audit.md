...
The earlier suspected mojibake resource paths were a PowerShell default-decoding false positive. Reading the same files as UTF-8 shows valid paths such as `res://assets/battle/units/f1_Baast冠军/visual.tres`.
